...
const Page: NextPage<InferGetStaticPropsType<typeof getStaticProps>> = ({ tracks, endDate, startDate }) => {
	...
	return (
		<>
			...
			<form className="grid md:grid-cols-2 gap-x-8 lg:gap-x-16 gap-y-4 md:gap-y-8 self-start max-w-6xl px-4 py-12 xl:px-8 2xl:px-32 mx-auto" onSubmit={handleSubmit}>
